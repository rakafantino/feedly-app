...
async function main() {
  ...
  const supplierData = [
    { name: 'PT Pakan Ternak Nusantara', email: 'sales@ptn.co.id', phone: '0218765432', storeId: defaultStore.id },
    { name: 'CV Nutrisi Hewan Indonesia', email: 'order@nhi.id', phone: '0227654321', storeId: defaultStore.id },
    { name: 'UD Vitamin Ternak Sejahtera', email: 'info@vts.com', phone: '0248765432', storeId: secondStore.id },
  ];
