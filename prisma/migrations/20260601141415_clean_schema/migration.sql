...
CREATE TABLE "purchase_order_payments" (
    ...
    "remaining_debt_before" DOUBLE PRECISION NOT NULL DEFAULT 0,
    "remaining_debt_after" DOUBLE PRECISION NOT NULL DEFAULT 0,
...
-- CreateIndex
CREATE INDEX "price_histories_product_id_created_at_idx" ON "price_histories"("product_id", "created_at");
