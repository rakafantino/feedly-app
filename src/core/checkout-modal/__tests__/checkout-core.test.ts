...
import { CartItemType, PaymentMethod, Customer } from "../checkout-core";
...
describe("calculateTotals", () => {
  const mockItems: CartItemType[] = [createMockCartItem({ price: 10000, quantity: 2 }), createMockCartItem({ id: "item-2", name: "Item 2", price: 15000, quantity: 1 })];
...
describe("calculateTotalPayment", () => {
  ...
  it("handles empty amounts", () => {
    const methods: PaymentMethod[] = [{ method: "CASH", amount: "" }];
...
describe("getCartItemCount", () => {
  it("sums quantities", () => {
    const items = [createMockCartItem({ quantity: 2 }), createMockCartItem({ id: "item-2", quantity: 3 })];
...
describe("calculateCartSubtotal", () => {
  it("calculates correctly", () => {
    const items = [createMockCartItem({ price: 10000, quantity: 2 }), createMockCartItem({ id: "item-2", price: 15000, quantity: 1 })];
...
describe("formatCartSummary", () => {
  it("formats correctly", () => {
    const items = [createMockCartItem({ price: 10000, quantity: 2 })];
